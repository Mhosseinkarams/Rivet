...
namespace Rivet {
  ...
  class CMS_1602_PAS_SMP_19_005 : public Analysis {
  public:

    CMS_1602_PAS_SMP_19_005()
      : Analysis("CMS_1602_PAS_SMP_19_005")
  ...
  public:
    ...
    void finalize() {
      ...
      const double norm = crossSection() * 6.791/picobarn;
  ...
  DECLARE_RIVET_PLUGIN(CMS_1602_PAS_SMP_19_005);
