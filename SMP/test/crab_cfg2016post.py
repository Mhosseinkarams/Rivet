...
config = config()
config.General.requestName = 'VJJ_Rivet2016post'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runRivetAnalyzer_VJJ_miniAOD2016post.py'
config.JobType.outputFiles = ['out.yoda']
config.JobType.inputFiles = ['../data/CMS_1602_PAS_SMP_19_005.yoda','runRivetAnalyzer_VJJ_miniAOD2016post.py','../../rivetSetup.sh']
config.JobType.scriptExe = 'crab_script2016post.sh'
