...
config = config()
config.General.requestName = 'VJJ_Rivet'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'runRivetAnalyzer_VJJ_miniAOD.py'
config.JobType.outputFiles = ['out.yoda']
config.JobType.inputFiles = ['../data/CMS_2024_PAS_SMP_24_005.yoda','runRivetAnalyzer_VJJ_miniAOD.py','../../rivetSetup.sh']
